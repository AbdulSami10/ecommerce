const products = [
  {
    ...
    description:
      "Experience unparalleled audio quality with our flagship wireless headphones. Featuring active noise cancellation, 40-hour battery life, and premium memory foam cushions.",
    featured: true,
  },
  {
    id: 2,
    ...
    description:
      "Your ultimate fitness companion with advanced health monitoring, GPS tracking, and seamless smartphone integration. Water-resistant up to 50 meters.",
    featured: true,
  },
  {
    id: 3,
    ...
    description:
      "Immersive 360° sound experience with our premium smart speakers. Voice-controlled with multi-room audio support and stunning design.",
    featured: true,
  },
  {
    id: 4,
    ...
    description:
      "Precision gaming controller with adaptive triggers, haptic feedback, and customizable buttons. Compatible with all major platforms.",
  },
  {
    id: 5,
    ...
    description:
      "Next-generation virtual reality with 4K resolution per eye, inside-out tracking, and an extensive game library. Step into new worlds.",
    featured: true,
  },
  {
    id: 6,
    ...
    description:
      "Transform your space with 16 million colors and smart scheduling. Works with all major voice assistants and smart home systems.",
  },
  {
    id: 7,
    ...
    description:
      "True wireless earbuds with spatial audio, adaptive EQ, and up to 30 hours of battery life with the charging case.",
    featured: true,
  },
  {
    id: 8,
    ...
    emoji: "🔋",
    image:
      "https://images.unsplash.com/photo-1586816879360-004f5b0c51e5?w=400&q=80",
    description:
      "Fast wireless charging for all Qi-compatible devices. Sleek design with LED charging indicator and foreign object detection.",
  },
  {
    id: 9,
    name: "Nexus Hub Max",
    ...
    description:
      "The central hub for your smart home. Control all your devices, stream content, and make video calls on the beautiful 10-inch display.",
  },
  {
    id: 10,
    ...
    description:
      "Ultra-precise gaming mouse with 25,000 DPI sensor, programmable buttons, and RGB lighting. Designed for esports professionals.",
  },
  {
    id: 11,
    ...
    description:
      "20,000mAh portable power bank with fast charging support. Charge multiple devices simultaneously with the transparent design.",
  },
  {
    id: 12,
    ...
    description:
      "Lightweight fitness tracker with heart rate monitoring, sleep analysis, and 14-day battery life. Your 24/7 health companion.",
    featured: true,
  },
];
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    $$(".stat-value[data-count]").length ||
    $$(".stat-number[data-count]").length
  ) {
